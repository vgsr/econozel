 ...
 * @since 0.1.1
 * @version 0.1.9
 * @author JJJ <https://github.com/stuttter>
 *
...
class WP_Term_Meta_UI {
	 ...
	 * @return mixed
	 */
	public function add_column_value( $content = '', $custom_column = '', $term_id = 0 ) {

		// Bail if no taxonomy passed or not on the `meta_key` column
		if ( empty( $_REQUEST['taxonomy'] ) || ( $this->meta_key !== $custom_column ) || ! empty( $content ) ) {
			return $content;
		}
